...
export class DeploymentStack extends cdk.Stack {
    ...
    constructor(scope: cdk.Construct, id: string, props: DeploymentStackProps) {
        ...
        const thundraApiKey = this.node.tryGetContext('sidekickApiKey');
        ...
        const petClinicApp = new ecsPatterns.ApplicationLoadBalancedFargateService(this, 'PetClinicAppFargateService', {
            ...
            taskImageOptions: {
                ...
                environment: {
                    ...
                    sidekick_apiKey: thundraApiKey,
                    sidekick_agent_trace_integrations_spring_web_path_depth: '2',
                    sidekick_agent_application_name: 'petclinic-app',
                    sidekick_agent_application_version: '1.0.0',
                    sidekick_agent_application_stage: 'aws',
                    SIDEKICK_BROKER_HOST: 'wss://broker.service.runsidekick.me',
                    SIDEKICK_BROKER_PORT: 443
                },
                secrets: {
